...
public class PrecloseScreenIAS : MonoBehaviour {
    ...
    public List<Texture2D> preBannerTextures = new List<Texture2D>();
	...
	public static PrecloseScreenIAS Instance;
	...
	private IEnumerator FetchPreCloseBannerData()
	{
		...
		EventController.I.PostEvent("LoadedIAS", gameObject);		
	}
}
